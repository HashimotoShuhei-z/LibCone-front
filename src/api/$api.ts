    ...
    api: {
      admin: {
        register: {
          ...
          post: (option: { body: Methods_1ctxhje['post']['reqBody']; config?: T | undefined }) =>
            fetch<Methods_1ctxhje['post']['resBody'], BasicHeaders, Methods_1ctxhje['post']['status']>(
              prefix,
              PATH0,
              POST,
              option
      ...
      book_purchase_requests: {
        confirm: {
          ...
          post: (option: { body: Methods_i5umi8['post']['reqBody']; config?: T | undefined }) =>
            fetch<Methods_i5umi8['post']['resBody'], BasicHeaders, Methods_i5umi8['post']['status']>(
              prefix,
              PATH2,
              POST,
              option
        ...
        get: (option?: { query?: Methods_1wsvm8f['get']['query'] | undefined; config?: T | undefined } | undefined) =>
          fetch<Methods_1wsvm8f['get']['resBody'], BasicHeaders, Methods_1wsvm8f['get']['status']>(
            prefix,
            PATH1,
            GET,
            option
        ...
        post: (option: { body: Methods_1wsvm8f['post']['reqBody']; config?: T | undefined }) =>
          fetch<Methods_1wsvm8f['post']['resBody'], BasicHeaders, Methods_1wsvm8f['post']['status']>(
            prefix,
            PATH1,
            POST,
            option
      ...
      book_reviews: {
          ...
          return {
            reaction: {
              ...
              post: (option: { body: Methods_1o9uhv5['post']['reqBody']; config?: T | undefined }) =>
                fetch<Methods_1o9uhv5['post']['resBody'], BasicHeaders, Methods_1o9uhv5['post']['status']>(
                  prefix,
                  `${prefix2}${PATH4}`,
                  POST,
                  option
            ...
            get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_1amq66t['get']['resBody'], BasicHeaders, Methods_1amq66t['get']['status']>(
                prefix,
                prefix2,
                GET,
                option
            ...
            put: (option: { body: Methods_1amq66t['put']['reqBody']; config?: T | undefined }) =>
              fetch<Methods_1amq66t['put']['resBody'], BasicHeaders, Methods_1amq66t['put']['status']>(
                prefix,
                prefix2,
                PUT,
                option
            ...
            $delete: (option?: { config?: T | undefined } | undefined) =>
              fetch<void, BasicHeaders, Methods_1amq66t['delete']['status']>(prefix, prefix2, DELETE, option)
                .send()
                .then((r) => r.body),
            $path: () => `${prefix}${prefix2}`
          }
        ...
        get: (option?: { query?: Methods_11otkqa['get']['query'] | undefined; config?: T | undefined } | undefined) =>
          fetch<Methods_11otkqa['get']['resBody'], BasicHeaders, Methods_11otkqa['get']['status']>(
            prefix,
            PATH3,
            GET,
            option
        ...
        post: (option: { body: Methods_11otkqa['post']['reqBody']; config?: T | undefined }) =>
          fetch<Methods_11otkqa['post']['resBody'], BasicHeaders, Methods_11otkqa['post']['status']>(
            prefix,
            PATH3,
            POST,
            option
      ...
      books: {
          ...
          return {
            borrow: {
              ...
              post: (option: { body: Methods_1qcctff['post']['reqBody']; config?: T | undefined }) =>
                fetch<Methods_1qcctff['post']['resBody'], BasicHeaders, Methods_1qcctff['post']['status']>(
                  prefix,
                  `${prefix2}${PATH6}`,
                  POST,
                  option
            ...
            return: {
              ...
              post: (option: { body: Methods_154q7xg['post']['reqBody']; config?: T | undefined }) =>
                fetch<Methods_154q7xg['post']['resBody'], BasicHeaders, Methods_154q7xg['post']['status']>(
                  prefix,
                  `${prefix2}${PATH7}`,
                  POST,
                  option
        ...
        scan_serch: {
          ...
          post: (option: { body: Methods_b1649x['post']['reqBody']; config?: T | undefined }) =>
            fetch<Methods_b1649x['post']['resBody'], BasicHeaders, Methods_b1649x['post']['status']>(
              prefix,
              PATH8,
              POST,
              option
      ...
      external_books: {
        ...
        get: (option?: { query?: Methods_1n3ybpf['get']['query'] | undefined; config?: T | undefined } | undefined) =>
          fetch<Methods_1n3ybpf['get']['resBody'], BasicHeaders, Methods_1n3ybpf['get']['status']>(
            prefix,
            PATH9,
            GET,
            option
      ...
      gift: {
        ...
        post: (option: { body: Methods_s0wyhp['post']['reqBody']; config?: T | undefined }) =>
          fetch<Methods_s0wyhp['post']['resBody'], BasicHeaders, Methods_s0wyhp['post']['status']>(
            prefix,
            PATH10,
            POST,
            option
      ...
      gift_request: {
        _request_id: (val2: string) => {
          ...
          return {
            ...
            $delete: (option?: { config?: T | undefined } | undefined) =>
              fetch<void, BasicHeaders, Methods_18x8mvl['delete']['status']>(prefix, prefix2, DELETE, option)
                .send()
                .then((r) => r.body),
            $path: () => `${prefix}${prefix2}`
          }
         ...
         */
        get: (option?: { config?: T | undefined } | undefined) =>
          fetch<Methods_1uudg0h['get']['resBody'], BasicHeaders, Methods_1uudg0h['get']['status']>(
            prefix,
            PATH11,
            GET,
            option
        ...
        post: (option: { body: Methods_1uudg0h['post']['reqBody']; config?: T | undefined }) =>
          fetch<Methods_1uudg0h['post']['resBody'], BasicHeaders, Methods_1uudg0h['post']['status']>(
            prefix,
            PATH11,
            POST,
            option
      ...
      internal_books: {
        _book_id: (val2: number) => {
          ...
          return {
             ...
             */
            get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_1aoprwb['get']['resBody'], BasicHeaders, Methods_1aoprwb['get']['status']>(
                prefix,
                prefix2,
                GET,
                option
            ...
            put: (option: { body: Methods_1aoprwb['put']['reqBody']; config?: T | undefined }) =>
              fetch<Methods_1aoprwb['put']['resBody'], BasicHeaders, Methods_1aoprwb['put']['status']>(
                prefix,
                prefix2,
                PUT,
                option
            ...
            $delete: (option?: { config?: T | undefined } | undefined) =>
              fetch<void, BasicHeaders, Methods_1aoprwb['delete']['status']>(prefix, prefix2, DELETE, option)
                .send()
                .then((r) => r.body),
            $path: () => `${prefix}${prefix2}`
          }
        ...
        get: (option?: { query?: Methods_1c9fcpl['get']['query'] | undefined; config?: T | undefined } | undefined) =>
          fetch<Methods_1c9fcpl['get']['resBody'], BasicHeaders, Methods_1c9fcpl['get']['status']>(
            prefix,
            PATH12,
            GET,
            option
        ...
        post: (option: { body: Methods_1c9fcpl['post']['reqBody']; config?: T | undefined }) =>
          fetch<Methods_1c9fcpl['post']['resBody'], BasicHeaders, Methods_1c9fcpl['post']['status']>(
            prefix,
            PATH12,
            POST,
            option
      ...
      lending_logs: {
        _log_id: (val2: number) => {
          ...
          return {
            ...
            put: (option: { body: Methods_1ce8zwj['put']['reqBody']; config?: T | undefined }) =>
              fetch<Methods_1ce8zwj['put']['resBody'], BasicHeaders, Methods_1ce8zwj['put']['status']>(
                prefix,
                prefix2,
                PUT,
                option
            ...
            $delete: (option?: { config?: T | undefined } | undefined) =>
              fetch<void, BasicHeaders, Methods_1ce8zwj['delete']['status']>(prefix, prefix2, DELETE, option)
                .send()
                .then((r) => r.body),
            $path: () => `${prefix}${prefix2}`
          }
        ...
        get: (option?: { query?: Methods_7wg8tu['get']['query'] | undefined; config?: T | undefined } | undefined) =>
          fetch<Methods_7wg8tu['get']['resBody'], BasicHeaders, Methods_7wg8tu['get']['status']>(
            prefix,
            PATH13,
            GET,
            option
        ...
        post: (option: { body: Methods_7wg8tu['post']['reqBody']; config?: T | undefined }) =>
          fetch<Methods_7wg8tu['post']['resBody'], BasicHeaders, Methods_7wg8tu['post']['status']>(
            prefix,
            PATH13,
            POST,
            option
      ...
      login: {
        ...
        post: (option: { body: Methods_zy1cq8['post']['reqBody']; config?: T | undefined }) =>
          fetch<Methods_zy1cq8['post']['resBody'], BasicHeaders, Methods_zy1cq8['post']['status']>(
            prefix,
            PATH14,
            POST,
            option
      ...
      logout: {
        ...
        $post: (option?: { config?: T | undefined } | undefined) =>
          fetch<void, BasicHeaders, Methods_15ld6mt['post']['status']>(prefix, PATH15, POST, option)
            .send()
            .then((r) => r.body),
        $path: () => `${prefix}${PATH15}`
      },
      my_page: {
         ...
         */
        get: (option?: { config?: T | undefined } | undefined) =>
          fetch<Methods_hamwiv['get']['resBody'], BasicHeaders, Methods_hamwiv['get']['status']>(
            prefix,
            PATH16,
            GET,
            option
      ...
      purchase: {
        ...
        post: (option: { body: Methods_sw1z9w['post']['reqBody']; config?: T | undefined }) =>
          fetch<Methods_sw1z9w['post']['resBody'], BasicHeaders, Methods_sw1z9w['post']['status']>(
            prefix,
            PATH17,
            POST,
            option
      ...
      reading_memos: {
        _memo_id: (val2: number) => {
          ...
          return {
             ...
             */
            get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_j5m14a['get']['resBody'], BasicHeaders, Methods_j5m14a['get']['status']>(
                prefix,
                prefix2,
                GET,
                option
            ...
            put: (option: { body: Methods_j5m14a['put']['reqBody']; config?: T | undefined }) =>
              fetch<Methods_j5m14a['put']['resBody'], BasicHeaders, Methods_j5m14a['put']['status']>(
                prefix,
                prefix2,
                PUT,
                option
            ...
            $delete: (option?: { config?: T | undefined } | undefined) =>
              fetch<void, BasicHeaders, Methods_j5m14a['delete']['status']>(prefix, prefix2, DELETE, option)
                .send()
                .then((r) => r.body),
            $path: () => `${prefix}${prefix2}`
          }
         ...
         */
        get: (option?: { config?: T | undefined } | undefined) =>
          fetch<Methods_1t3z2tz['get']['resBody'], BasicHeaders, Methods_1t3z2tz['get']['status']>(
            prefix,
            PATH18,
            GET,
            option
        ...
        post: (option: { body: Methods_1t3z2tz['post']['reqBody']; config?: T | undefined }) =>
          fetch<Methods_1t3z2tz['post']['resBody'], BasicHeaders, Methods_1t3z2tz['post']['status']>(
            prefix,
            PATH18,
            POST,
            option
      ...
      users: {
        _user_id: (val2: number) => {
          ...
          return {
            reading_log: {
               ...
               */
              get: (option?: { config?: T | undefined } | undefined) =>
                fetch<Methods_16kpjc9['get']['resBody'], BasicHeaders, Methods_16kpjc9['get']['status']>(
                  prefix,
                  `${prefix2}${PATH20}`,
                  GET,
                  option
             ...
             */
            get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_8cxs5p['get']['resBody'], BasicHeaders, Methods_8cxs5p['get']['status']>(
                prefix,
                prefix2,
                GET,
                option
            ...
            put: (option: { body: Methods_8cxs5p['put']['reqBody']; config?: T | undefined }) =>
              fetch<Methods_8cxs5p['put']['resBody'], BasicHeaders, Methods_8cxs5p['put']['status']>(
                prefix,
                prefix2,
                PUT,
                option
        ...
        register: {
          ...
          post: (option: { body: Methods_1qpsavf['post']['reqBody']; config?: T | undefined }) =>
            fetch<Methods_1qpsavf['post']['resBody'], BasicHeaders, Methods_1qpsavf['post']['status']>(
              prefix,
              PATH21,
              POST,
              option
        ...
        get: (option?: { query?: Methods_80a9vt['get']['query'] | undefined; config?: T | undefined } | undefined) =>
          fetch<Methods_80a9vt['get']['resBody'], BasicHeaders, Methods_80a9vt['get']['status']>(
            prefix,
            PATH19,
            GET,
            option
